...
export default function BotsPage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await api.post('/api/v1/bots/upload', fd, { headers: { 'Content-Type': 'multipart/form-data' } })
            ...
            <div className="bg-[#0f1623] border border-[#1e2a3a] rounded-xl p-6 w-full max-w-lg">
              ...
              <div className="space-y-4">
                <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-3 text-xs text-blue-300">
                  📦 Zip your entire bot folder (e.g. <code>spx_credit_spread.zip</code>). The entry file (default: <code>main.py</code>) runs on execution. IBKR credentials are injected as env vars automatically.
                </div>
